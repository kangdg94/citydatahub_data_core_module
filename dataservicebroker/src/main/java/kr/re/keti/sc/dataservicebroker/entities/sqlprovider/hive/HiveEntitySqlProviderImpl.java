...
public class HiveEntitySqlProviderImpl {
	...
	private static final String START_OF_INPUT_VALUE = "'";
	private static final String END_OF_INPUT_VALUE = "'";
	...
	private static final String INT_ARRAY_COLUME_FORMAT_PRE_STRING = "ST_ARRAYINT("; 
	private static final String DOUBLE_ARRAY_COLUME_FORMAT_PRE_STRING = "ST_ARRAYDOUBLE("; 
	private static final String TIMESTAMP_ARRAY_COLUME_FORMAT_PRE_STRING = "ST_ARRAYTIMESTAMP("; 
	private static final String BOOLEAN_ARRAY_COLUME_FORMAT_PRE_STRING = "ST_ARRAYBOOLEAN("; 
	private static final String GEO_4326_COLUME_FORMAT_PRE_STRING = "ST_AsGeoJson(ST_GeomFromGeoJSON("; 
	private static final String GEO_4326_COLUME_FORMAT_END_STRING = "))"; 
	private static final String GEO_4326_IDX_COLUME_FORMAT_PRE_STRING = "ST_DISKINDEX(ST_asText(ST_GeomFromGeoJSON("; 
	private static final String GEO_4326_IDX_COLUME_FORMAT_END_STRING = ")))"; 
	private static final String GEO_3857_COLUME_FORMAT_PRE_STRING = "ST_AsGeoJson(ST_Transform(ST_FlipCoordinates(ST_GeomFromGeoJSON("; 
	private static final String GEO_3857_COLUME_FORMAT_END_STRING = ")), 'epsg:4326','epsg:3857'))"; 
	/**
	 * 테이블 생성을 위한 DDL
	 *
